  ...
  return (
    <div className="section !mt-[14em]" id="innovation">
      <div className="sectionWrapper justify-start flex-col flex-1 items-start gap-16">
        <div className="!h-[min] flex justify-between  flex-row flex-1 items-start gap-16 z-[1] pointer-events-none">
          <div className="w-[30%] font-tabletgothic flex flex-col gap-4 z-[1] pointer-events-none">
          ...
          <div className="w-[70%] relative flex flex-col gap-8 z-[1] pointer-events-none">
